...
public class Config {
	...
	private String play_port;//播放端口
	private String recorder_port;//录像机服务端口

	public String getRecorder_port() {
		return recorder_port;
	}

	public void setRecorder_port(String recorder_port) {
		this.recorder_port = recorder_port;
	}

	public String getPlay_port() {
		return play_port;
	}

	public void setPlay_port(String play_port) {
		this.play_port = play_port;
	}
